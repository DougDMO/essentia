@pre_appointment_colab @login_colab @all
Feature: Pre Medical Appointment Model - Collaborator

  Background:
    Given I'm on Pre Medical Appointment Model page

  @pre_appointment_model_create
  Scenario: Create a Pre Medical Appointment Model
    Given I fill new pre appointment model Colab
    And I fill Doctor in pre appointment model
