@report_colab @login_colab @all
Feature: Report Model Collaborator

  Background:
    Given I'm on Report Model page

  @report_model_create
  Scenario: Create a Report Model
    Given I fill new Report model Colab
    #And I fill Doctor in Report model
  ...
  Scenario: Edit a Report Model
    ...
    When I update the report model Colab
    When I save the report
    Then I see the success message "Salvo com sucesso"
    And I see the model on the report list
  ...
  Scenario: Duplicate a report Model
    ...
    And I update the report model Colab
    #And I fill Doctor in Report model
