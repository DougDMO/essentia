class AnamnesePage < SitePrism::Page
  ...
  element :button_back, '#TDD-MODELANAMNESIS-back'
  ...
  element :radio_private_yes_c, :xpath, '/html/body/fuse-root/fuse-main/mat-sidenav-container/mat-sidenav-content/div/div/div/fuse-content/app-edit-text-model/div/div[2]/div/div/div/form/div/div[2]/div/div/div[1]/label'
  element :radio_private_no_c, :xpath, '/html/body/fuse-root/fuse-main/mat-sidenav-container/mat-sidenav-content/div/div/div/fuse-content/app-edit-text-model/div/div[2]/div/div/div/form/div/div[2]/div/div/div[2]/label'
